 ...
 */
/*
 * Получаем в статичные свойства данные о странице
 * Тип статичный или динамичный
 *      статичный роут - это роут прописан в файле routings.php. Разбивается на данные в зависимости от прописаного в файле
 *      динамичный роут - роут которого нет в routing.php. Данные получаются c разбора запроса.
 * */
class Route{
